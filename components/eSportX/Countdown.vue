<template>
  ...
  <div class="container mt-32 pb-32 text-white text-center">
    <h2 class="text-3xl lg:text-5xl font-blackOps uppercase mb-8">
      Event Countdown
    </h2>
    <div class="grid md:grid-cols-4 grid-cols-2 gap-8">
      <div class="countdown-block">
        <p class="text-5xl lg:text-7xl font-bold text-yellow">{{ countdown.days }}</p>
        <p class="uppercase mt-2 text-lg">Days</p>
      </div>
      <div class="countdown-block">
        <p class="text-5xl lg:text-7xl font-bold text-bright">{{ countdown.hours }}</p>
        <p class="uppercase mt-2 text-lg">Hours</p>
      </div>
      <div class="countdown-block">
        <p class="text-5xl lg:text-7xl font-bold text-punch">{{ countdown.minutes }}</p>
        <p class="uppercase mt-2 text-lg">Minutes</p>
      </div>
      <div class="countdown-block">
        <p class="text-5xl lg:text-7xl font-bold text-primary">{{ countdown.seconds }}</p>
