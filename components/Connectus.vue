    ...
    <div class="container flex items-center space-x-4 flex-col lg:flex-row">
      ...
      <div class="w-full lg:w-1/2">
        <div class="about_title lg:mb-6 mb-4">
          ...
          >
          Connection With Our Esports Community
          </h5>
        </div>
        <div class="xl:mb-2 sm:mb-2 mt-6 mb-2">
            ...
            >
            Esports Team Communication: 
            </h3>
          </div>
        <div class="about_desc mb-10">
      <p> Esports members, including players, coaches, and team staff, should be connected through various means to enhance their performance, teamwork, and overall experience.</p>
      ...
      <div class="xl:mb-2 sm:mb-2 mt-6 mb-2">
          ...
          <p>
            Regular communication is crucial in esports, where split-second decisions can make a significant difference in matches. Connected members can communicate effectively through voice or text chat, ensuring they're on the same page and can coordinate strategies.
          </p>
        </div>
        ...
        <div class="xl:mb-2 sm:mb-2 mt-6 mb-2">
          ...
          <p>
            Connected members can share data, such as game statistics, replays, and analysis, to improve their gameplay and identify areas for improvement.
          </p>
