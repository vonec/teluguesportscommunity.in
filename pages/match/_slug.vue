      ...
      >
        <div class="grid grid-cols-1 items-center">
          <div class="flex justify-center items-center w-full px-20 sm:px-0">
            <img
              class="lg:mr-9 mr-5"
              :src="matchesData.teamOne"
              alt="Feature Icon"
            />
            <img
              class="lg:mr-9 mr-5"
              :src="matchesData.teamVs"
              alt="Feature Icon"
            />
...
export default {
  ...
  mounted() {
    this.matchesData = matchesData.find(
      (match) => match.slug == this.$route.params.slug
    );
  },
  methods: {
