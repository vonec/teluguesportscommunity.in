    ...
    <div class="container">
      <div class="grid grid-cols-1">
        ...
        >
          <div class="team-top-area mt-5 min-w-sm mx-auto text-center">
            ...
            <div class="team-socials-area mt-8">
              ...
              <a href="https://www.facebook.com" class="ml-2"
                ><i class="icofont-facebook"></i
              ></a>
              <a href="https://dribbble.com" class="ml-2"
                ><i class="icofont-dribbble"></i
              ></a>
              <a href="https://www.youtube.com" class="ml-2"
                ><i class="icofont-youtube-play"></i
              ></a>
              <a href="https://www.twitter.com" class="ml-2"
                ><i class="icofont-twitter"></i
              ></a>
            </div>
          </div>
          <div class="about-the-team-area mt-5 md:ml-15">
            <h3 class="text-primary uppercase font-bold text-[25px]">
              About Team
            </h3>
            <div class="about-description mt-5 max-w-3xl">
              <p class="leading-7">
                Lorem ipsum dolor sit amet consectetur dolor sit amet
                consectetur adipisicing elit. Sapiente, consequatur quae
                pariatur aut deserunt nemo provident, possimus iste dolor dicta
                sint porro ut. Eveniet libero voluptatum architecto adipisicing
                elit. Sapiente, consequatur quae pariatur aut deserunt nemo
                provident, possimus iste dolor dicta sint porro ut. Eveniet
                libero voluptatum architecto ratione corrupti cupiditate!
              </p>
            </div>
            <div
              class="play-game-history mt-10 grid grid-cols-2 sm:grid-cols-4 gap-3 p-5 rounded-md bg-secondary-90"
            >
        ...
        <div class="about-the-team-area mt-16">
          <h2 class="text-primary uppercase font-bold text-[25px] mb-8">
            Team Player's
          </h2>
          <div
          ...
          >
            <div
              class="text-center"
              v-for="(member, index) in battleData.teamplayers"
              :key="index"
            >
...
export default {
  ...
  mounted() {
    this.battleData = battleData.find(
      (member) => this.slugify(member.battlename) == this.$route.params.slug
    );
  },
  methods: {
    slugify(text) {
